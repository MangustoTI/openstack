...
public enum TypeTemplate {
	...
	SERVICE("/service/", "/service/impl/",
			"Service.java", "ServiceImpl.java", "ServiceImplTest.java", "ServiceTemplate.vm",
			"ServiceTemplateImpl.vm", "ServiceTemplateImplTest.vm"),

	DAO("/dao/", "/dao/impl/", "Dao.java", "DaoImpl.java", "DaoImplTest.java", "DaoTemplate.vm",
			"DaoTemplateImpl.vm", "DaoTemplateImplTest.vm"),

	ENTITY(null, "/model/domain/", null, ".java", "Test.java", null, "EntityTemplate.vm", "EntityTemplateTest.vm"),

	SERVICEDAO("/service/", "/service/impl/",
			"Service.java", "ServiceImpl.java", "ServiceImplTest.java", "ServiceTemplate.vm",
			"ServiceTemplateImpl.vm", "ServiceTemplateImplTest.vm"),

	ENUM(null, "/model/type/", null, "Indicador.java", null, null, "EnumTemplate.vm", null),
	...
	DTO(null, "/model/dto/", null, "DTO.java", null, null, "DTOTemplate.vm", null),
